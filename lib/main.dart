...
final lightTheme = ThemeData(
  colorScheme: const ColorScheme.light(
    ...
    onSecondary: Color.fromARGB(255, 172, 172, 172), // Added for better text contrast
    surface: Color.fromARGB(222, 225, 225, 225),
    onSurface: Color.fromARGB(255, 243, 243, 243), // Darkened for better contrast
  ...
  textTheme: TextTheme(
    ...
    labelSmall: TextStyle(
      color: const Color.fromARGB(255, 65, 65, 65), // Darkened for better contrast
      fontSize: 12.sp,
      fontFamily: 'Ubuntu',
      fontWeight: FontWeight.w400,
    ),
...
final darkTheme = ThemeData(
  colorScheme: const ColorScheme.dark(
      ...
      onPrimary: Color.fromARGB(255, 200, 200, 200), // Lightened for better contrast
      secondary: Color.fromARGB(255, 200, 60, 40), // Distinct bright color for buttons
      onSecondary: Color.fromARGB(255, 255, 255, 255),
      surface: Color.fromARGB(255, 48, 48, 48),
      onSurface: Color.fromARGB(255, 66, 66, 66), // Lightened for better contrast
  ...
  textTheme: TextTheme(
    ...
    labelSmall: TextStyle(
      color: const Color.fromARGB(255, 180, 180, 180), // Lightened for better readability
      fontSize: 12.sp,
      fontFamily: 'Ubuntu',
      fontWeight: FontWeight.w400,
    ),
